  ...
  <div class="fixed top-0 bg-white text-lg rounded mx-auto md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mt-16 md:mt-32 shadow-lg z-40 inset-x-0">
    ...
    <div class="flex flex-row">
      <div class="bg-blue-200">
        <div class="overflow-auto overflow-y-scroll overflow-x-hidden h-50-vh w-20 lg:w-24 xxl:w-28">
          <div @click="selectUserMessage(user, index)"
            ...
            <img @mouseover="hover = true" @mouseleave="hover = false"  class="tooltip w-10 lg:w-12 h-10 lg:h-12 rounded-full cursor-pointer" :title="user.name" :src="generateUrl(user.avatar)">
