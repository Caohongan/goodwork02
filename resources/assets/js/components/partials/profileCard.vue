...
<div class="relative inline">
  ...
  <div @mouseover="showProfileCard()" @mouseleave="hideProfileCard()" v-if="profileCardShown" class="absolute w-48 -ml-20 pt-4 -mt-2 z-30">
    <div class="flex flex-col items-center justify-center bg-blue-900 text-white rounded-lg shadow ">
      <!-- <img :src="generateUrl(user.avatar)" class="rounded-full w-5 h-5"> -->
