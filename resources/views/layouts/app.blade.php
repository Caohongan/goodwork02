...
<head>
    ...
    <link rel = "icon" href = "https://lhu.edu.vn/ViewPage/LHUVN/_default/image/truong_dai_hoc_lac_hong_logo.png" type = "image/x-icon"> 
...
<body class="bg-gray-200 text-gray-700">
    ...
    <div class="text-center mt-5">© 2020 Lạc Hồng University</div>
